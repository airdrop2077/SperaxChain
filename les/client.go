...
import (
	...
	"github.com/Sperax/SperaxChain/les/checkpointoracle"
	lpc "github.com/Sperax/SperaxChain/les/lespay/client"
	"github.com/Sperax/SperaxChain/light"
...
func New(ctx *node.ServiceContext, config *eth.Config) (*LightEthereum, error) {
	...
	leth := &LightEthereum{
		...
		engine:         eth.CreateConsensusEngine(ctx, chainConfig, bdls_engine.FakerConfig, nil, false, chainDb),
